...
while True:
		...
		while k<len(feedpin):
			...
			jsonstring ="{\n\"feeds\":[{\"feedname\":\"%s\",\n\"feedtype\":\"%s\",\n\"feedpin\":\"%d\",\"feedvalue\":\"%d\"}," % (feedname[k],feedtype[k],feedpin[k],sout1)
			k = k+1
			if k<len(feedpin):
				if connectiontype[k] == "GPIO":
				...
				jsonstring = jsonstring + "\n{\"feedname\":\"%s\",\n\"feedtype\":\"%s\",\n\"feedpin\":\"%d\",\"feedvalue\":\"%d\"}," % (feedname[k],feedtype[k],feedpin[k],sout2) 
				k = k+1
			else:
				jsonstring = jsonstring + "\n{\"feedname\":\"\",\n\"feedtype\":\"\",\n\"feedpin\":\"\",\"feedvalue\":\"\"},"
			if k<len(feedpin):
				...
				jsonstring = jsonstring + "\n{\"feedname\":\"%s\",\n\"feedtype\":\"%s\",\n\"feedpin\":\"%d\",\"feedvalue\":\"%d\"}]," % (feedname[k],feedtype[k],feedpin[k],sout3)
                                k = k+1
			else:
				jsonstring = jsonstring + "\n{\"feedname\":\"\",\n\"feedtype\":\"\",\n\"feedpin\":\"\",\"feedvalue\":\"\"}],"
